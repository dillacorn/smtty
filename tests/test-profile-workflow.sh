...
[[ "$editor_block" == *'"[D] [5]" "Display"'* ]]
[[ "$editor_block" == *'"[R] [8]" "Resolution"'* ]]
[[ "$editor_block" == *'smtty_print_action_row "[F] [2]" "Refresh"'* ]]
[[ "$editor_block" == *'"[E] [6]" "Features"'* ]]
[[ "$editor_block" == *'"[P] [9]" "PipeWire"'* ]]
[[ "$editor_block" == *'smtty_print_action_row "[C] [3]" "Shader cache"'* ]]
[[ "$editor_block" == *'"[L] [7]" "LD_PRELOAD"'* ]]
[[ "$editor_block" == *'"[A] [10]" "Audio"'* ]]
[[ "$editor_block" == *'smtty_print_action_row "[H] [4]" "Hooks" "[S]" "Save" "[Q]" "Cancel"'* ]]
[[ "$editor_block" == *'t|1)'* ]]
[[ "$editor_block" == *'d|5)'* ]]
[[ "$editor_block" == *'r|8)'* ]]
[[ "$editor_block" == *'f|2)'* ]]
